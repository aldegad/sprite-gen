...
## v1.59.0 "Edge Runner" - chroma.mode: ycbcr (perfectpixel-studio 이식, 옵트인)
...
## v1.58.0 "Edge Runner" - segmentation: projection (perfectpixel-studio 이식, 옵트인)
...
## v1.57.0 "Edge Runner" - align_x: alpha-centroid (perfectpixel-studio 이식, 옵트인)
