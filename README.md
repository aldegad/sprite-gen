...
The raw row images (step 2 of the quickstart) are generated by the separate [`image-gen`](https://github.com/aldegad/image-gen) skill (declared as `kuma:image-gen` in `SKILL.md` `depends_on`). Install it the same way:
