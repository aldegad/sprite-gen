...
Boundary (SoC): declaration truth is `sprite_gen.layers` (filesystem-free —
...
from sprite_gen.breathe import fit_breathe_pattern, phase_frame, resolve_anatomy
from sprite_gen.compose_atlas import cell_geometry
from sprite_gen.curation import (apply_pixel_edits, apply_transform, edit_index, frame_variant,
