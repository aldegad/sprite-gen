...
def _breathe_source_frame(run_dir: Path, state: str):
    ...
    from sprite_gen.curation import (apply_pixel_edits, apply_transform, edit_index,
...
def _base_grid_response(run_dir: Path, base_path: Path) -> dict:
    ...
    from sprite_gen.extract import (_grid_edges, detect_pixel_grid,
...
def _heal_attempt_key(run_dir: Path) -> tuple:
    ...
    """
    from sprite_gen.extract import engine_revision
        ...
        try:
            if path == "/api/curation":
                ...
                with publish_guard(self.run_dir):
                    ...
                    if not stale:
                        ...
                        # 2026-07-19: hero frozen 마커 소실, darami 무결성 감사 발견).
            ...
            if path == "/api/base-edit":
                ...
                if transform_req:
                    ...
                    from sprite_gen.curation import apply_transform as _apply_transform
                    from sprite_gen.curation import normalize_transform as _normalize_transform
