...
`sprite_gen.layers` answers what a request may declare; this file covers what only
...
from sprite_gen import compose_layers
from sprite_gen.curation import empty_curation, write_curation_atomic
