...
const STR = {
  en: {
    ...
    ppDeferred: (n) => `${n} pixel previews pending — reload to keep computing`,
    ...
    healNote: "Local CPU re-derivation — no model calls. The view opens automatically when it finishes.",
    healWaiting: "starting…",
  ...
  ko: {
    ...
    ppDeferred: (n) => `픽셀 프리뷰 ${n}개 대기 — 새로고침하면 이어서 계산`,
    ...
    healNote: "로컬 CPU 재계산이라 모델 호출이 없어요. 끝나면 자동으로 열립니다.",
    healWaiting: "시작하는 중…",
