...
const STR = {
  ...
  ko: {
    ...
    atlasStale: "편집 반영 안 됨",
    tCmpGif: "비교 캔버스를 루프 GIF 로 다운로드 (현재 배치+재생 그대로, 가상 시간 결정론 샘플)",
    cmpGifDone: "비교 GIF 다운로드 완료", cmpGifFail: "비교 GIF 실패: ",
