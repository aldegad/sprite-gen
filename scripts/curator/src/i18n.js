...
const STR = {
  en: {
    ...
    rowReroll: "Reroll", tRowReroll: "reroll this row once more and APPEND it as candidates (rerollN take) — the current frames are kept; the new roll's frames arrive labeled next to them. Click = GPT, Alt+click = Grok. Runs a full-batch re-extract, then the view reloads.",
  ...
  ko: {
    ...
    rowReroll: "리롤", tRowReroll: "이 줄을 한 번 더 생성해서 **후보군에 병기** (rerollN 테이크) — 기존 프레임은 그대로, 새 롤 프레임이 라벨 달고 옆에 온다. 클릭 = GPT, Alt+클릭 = Grok. 전체 배치 재추출 후 뷰가 새로고침된다.",
