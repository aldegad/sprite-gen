...
const STR = {
  en: {
    ...
    breatheAmp: "amp", breatheCad: (n) => `hold ${n}f`, breatheApply: "Apply",
    ...
    breatheHint: "drag the lines — the lowest band sinks first, upper bands follow a beat later. Apply bakes now (closing also applies), Cmd/Ctrl+Z steps adjustments back/forward, Esc cancels.",
  ...
  ko: {
    ...
    breatheAmp: "진폭", breatheCad: (n) => `유지 ${n}프레임`, breatheApply: "적용",
    ...
    breatheHint: "선을 드래그 — 맨 아래 밴드부터 가라앉고 위가 반 박자 늦게 따라옵니다. 적용 버튼으로 즉시 굽고(닫아도 적용), Cmd/Ctrl+Z 로 조정 이전/다음, Esc 취소.",
