...
const STR = {
  en: {
    ...
    tDurChip: "per-frame play-duration multiplier — click cycles x1 → x2 → x3 → x4 → x0.5 (bakes into GIF delays and manifest durations_ms)",
    rowBreathe: "Breathe", tDurChip: "이 프레임의 재생 길이 배수 — 클릭으로 x1 → x2 → x3 → x4 → x0.5 순환 (프레임별 duration, GIF·아틀라스 durations_ms 로 구워짐)",
    tRowBreathe: "breathing is a POST-PROCESS LAYER, orthogonal to frame selection — a blink frame breathes too. Check: turn it on (instant, saved to the sidecar; compose/GIF bake it deterministically). Uncheck: turn it off. Click the label to tune lines / amplitude / hold / sub-pixel over the LIVE playing sequence.",
