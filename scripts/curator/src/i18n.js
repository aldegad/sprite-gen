...
const STR = {
  en: {
    ...
    breatheAmp: "amp", breatheCount: (n) => `${n} breath${n > 1 ? "s" : ""}/loop`, breatheSub: "sub-pixel",
    tBreatheSub: "insert blended half-phase frames at transitions (sub-pixel animation — intermediate edge colors read as half-pixel motion)",
  ...
  ko: {
    ...
    breatheAmp: "진폭", breatheCount: (n) => `호흡 ${n}회/루프`, breatheSub: "서브픽셀",
    tBreatheSub: "위상 전이에 중간색 블렌드 프레임 삽입 (서브픽셀 애니메이션 — 경계 픽셀 중간색으로 반 픽셀 이동감)",
