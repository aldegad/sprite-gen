...
const STR = {
  en: {
    ...
    breatheAmp: "amp", breatheCountLabel: "breaths/loop", tBreatheCount: "breath count per loop — free number; a non-divisor is fitted to the nearest count that divides the loop (see the strip caption)", breatheSub: "sub-pixel (experimental)",
  ...
  ko: {
    ...
    breatheAmp: "진폭", breatheCountLabel: "호흡/루프", tBreatheCount: "루프당 호흡 횟수 — 자유 입력. 루프에 나눠떨어지지 않으면 가장 가까운 횟수로 보정 (스트립 캡션에 표시)", breatheSub: "서브픽셀 (실험)",
