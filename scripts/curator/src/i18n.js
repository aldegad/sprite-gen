...
const STR = {
  en: {
    ...
    tCmpPlay: "play/stop every sprite (own sequence, fps and breathing layer included)", cmpTitle: "Compare", cmpH: "horizontal", cmpV: "vertical", cmpOverlay: "overlay",
  ...
  ko: {
    ...
    tCmpPlay: "모든 스프라이트 재생/정지 (각자 시퀀스·fps·호흡 레이어 포함)", cmpTitle: "비교", cmpH: "수평", cmpV: "수직", cmpOverlay: "겹침",
