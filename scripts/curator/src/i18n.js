...
const STR = {
  en: {
    ...
    breatheAmp: "amp", breatheCad: (n) => `hold ${n}f`, breatheSub: "sub-pixel",
    ...
    breatheStrip: (n, m, lcm, shown) => `final bake: sequence ${n} × breath cycle ${m} = ${lcm}-frame loop` + (shown < lcm ? ` (showing first ${shown})` : ""),
  ...
  ko: {
    ...
    breatheAmp: "진폭", breatheCad: (n) => `유지 ${n}프레임`, breatheSub: "서브픽셀",
    ...
    breatheStrip: (n, m, lcm, shown) => `최종 굽기: 시퀀스 ${n} × 호흡 주기 ${m} = ${lcm}프레임 루프` + (shown < lcm ? ` (앞 ${shown}개 표시)` : ""),
