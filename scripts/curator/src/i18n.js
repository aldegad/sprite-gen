...
const STR = {
  en: {
    ...
    tAnchorFrameBadge: "this exact frame — as curated (pixel edits, transforms) — is the identity attached when generating the other rows of this direction",
    tSetAnchorFrame: "make this frame the direction anchor: the other rows of this direction are generated from THIS curated frame",
  ...
  ko: {
    ...
    anchorFrameBadge: "앵커",
    tAnchorFrameBadge: "이 프레임이 — 큐레이션(픽셀 편집·변형) 그대로 — 이 방향의 다른 행을 생성할 때 붙는 identity 다",
    tSetAnchorFrame: "이 프레임을 방향 앵커로 지정 — 이 방향의 다른 자세들을 바로 이 후처리된 프레임에서 생성한다",
