...
const STR = {
  en: {
    ...
    cmpTitle: "Anchor compare", cmpSide: "side-by-side", cmpOverlay: "overlay",
    cmpHint: "feet share the blue ground line · gray = each head top · click canvas to add a red guide (drag to move, double-click to remove)",
  ...
  ko: {
    ...
    cmpTitle: "앵커 비교", cmpSide: "나란히", cmpOverlay: "겹침",
    cmpHint: "발끝은 파란 바닥선 공유 · 회색 = 각 정수리선 · 캔버스 클릭 = 빨간 가이드 추가 (드래그 이동, 더블클릭 제거)",
